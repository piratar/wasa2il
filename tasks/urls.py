...
urlpatterns = [
    ...
    url(
        r'^polity/(?P<polity_id>\d+)/tasks/(?P<task_id>\d+)/edit/$',
        task_add_edit,
        name='task_edit',
    ),
    url(
        r'^polity/(?P<polity_id>\d+)/tasks/(?P<task_id>\d+)/delete/$',
        task_delete,
        name='task_delete',
    ),
    url(
        r'^polity/(?P<polity_id>\d+)/tasks/new/$',
        task_add_edit,
        name='task_add',
    ),
    url(
        r'^polity/(?P<polity_id>\d+)/tasks/(?P<task_id>\d+)/$',
        task_detail,
        name='task_detail',
    ),
    url(
        r'^polity/(?P<polity_id>\d+)/tasks/applications/$',
        task_applications,
        name='task_applications',
    ),
    url(
        r'^accounts/profile/(?:(?P<username>[^/]+)/tasks/)?$',
        task_user_tasks,
